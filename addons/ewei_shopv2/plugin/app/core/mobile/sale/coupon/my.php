...
class My_EweiShopV2Page extends AppMobilePage
{
    public function getlist()
    {
        ...
        foreach( $coupons as $i => &$row ) 
        {
            ...
            if( $row["backtype"] == 2 ) 
            {
                ...
                {
                    $title2 = $title2 . "送" . $row["backcredit"] . "卡路里";
                }
    ...
    public function getdetail()
    {
        ...
        if( $coupon["backtype"] == 2 ) 
        {
            ...
            {
                $title3 = $title3 . "送" . $coupon["backcredit"] . "卡路里 ";
            }
        ...
        if($data["couponid"]==2){//店主专享
            $detail['reurl'] = '/packageA/pages/changce/merch/detail?id=10';
        }
    ...
    public function showcoupons()
    {
        ...
        foreach( $coupons as $i => &$row ) 
        {
            ...
            if( $row["backtype"] == 2 ) 
            {
                ...
                if( !empty($row["backcredit"]) && 0 < $row["backcredit"] ) 
                {
                    $title2 = $title2 . "送" . $row["discount"] . "卡路里";
                }
        ...
        else
        {
            ...
            else
            {
                if( $data["backtype"] == 2 ) 
                {
                    ...
                    {
                        $data["title1"] .= "送" . $data["backcredit"] . "卡路里";
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        if( $row["backtype"] == 2 ) 
                        {
                            ...
                            if( !empty($row["backcredit"]) && 0 < $row["backcredit"] ) 
                            {
                                $row["title1"] .= "送" . $row["backcredit"] . "卡路里";
                            }
