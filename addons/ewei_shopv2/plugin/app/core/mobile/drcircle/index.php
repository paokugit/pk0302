...
class Index_EweiShopV2Page extends AppMobilePage{
    ...
    public function index(){
        ...
        if ($log){
            $count=pdo_fetch("select count(*) as a from ".tablename("ewei_shop_member_drcircle")." where create_time>:create_time and openid=:openid",array(":create_time"=>$log["create_time"],":openid"=>$openid));
            
            pdo_update("ewei_shop_member_drlog",array("create_time"=>time()),array("openid"=>$openid));
            
        }else{
            $count=pdo_fetch("select count(*) as a from ".tablename("ewei_shop_member_drcircle"));
            $d["openid"]=$openid;
            $d["create_time"]=time();
        ...
        foreach ($list as $k=>$v){
            ...
            if ($v["goods_id"]){
               ...
               $list[$k]["good"]["sales"]=$goods["sales"];
                ...
                $list[$k]["good"]["goods_id"]="";
                $list[$k]["good"]["img"]="";
                $list[$k]["good"]["title"]="";
                $list[$k]["good"]["subtitle"]="";
                $list[$k]["good"]["productprice"]="";
                $list[$k]["good"]["marketprice"]="";
                $list[$k]["good"]["sales"]="";
            }
            //获取用户信息
    ...
    public function detail(){
        ...
        if ($detail["goods_id"]){
            ...
            $detail["good"]["goods_id"]="";
            $detail["good"]["img"]="";
            $detail["good"]["title"]="";
            $detail["good"]["subtitle"]="";
            $detail["good"]["productprice"]="";
            $detail["good"]["marketprice"]="";
            $detail["good"]["sales"]="";
        }
        //获取用户信息
