...
class List_EweiShopV2Page extends WebPage 
{
	protected function orderData($status, $st) 
	{
		...
		$condition = "o.jdtype=0 and  o.uniacid = :uniacid and o.ismr=0 and o.deleted=0 and o.isparent=0 and o.istrade=0 and iscycelbuy=0 and type = 0";
		$uniacid = $_W["uniacid"];
...
// 				var_dump($good_refundid);
			...
			foreach( $list as $lk => $lv ) 
			{
				...
				$list[$lk]["uid"] = $omember[$lv["openid"]]["uid"];
				$list[$lk]["uid"] = $omember[$lv["openid"]]["uid"];
