		    ...
		    array(
	            ...
	            array(
	                ...
	                "list" => array(
	                    ...
	                    array( "name" => "必读通知", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/packageA/pages/shop/notice/notification/notification" ),
	                    array( "name" => "充值", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/packageA/pages/discount/zkbrechange/zkbrechange" ),
	                    array( "name" => "分类", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/packageA/pages/shop/caregory/index" ),
	                )
	            ),
	            ...
	            array( "name" => "店主专享", "url" => mobileUrl(NUlL, NULL, $full), "url_wxapp" => "/packageA/pages/changce/merch/detail?id=10" ),
