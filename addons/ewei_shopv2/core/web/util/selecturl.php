...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		$allUrls = array(
		    array( "name" => "商城页面", "list" => array( array( "name" => "商城首页", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/index/index" ), array( "name" => "分类导航", "url" => mobileUrl("shop/category", NULL, $full), "url_wxapp" => "/pages/shop/caregory/index" ), array( "name" => "全部商品", "url" => mobileUrl("goods", NULL, $full), "url_wxapp" => "/pages/goods/index/index" ),
                array( "name" => "公告页面", "url" => mobileUrl("shop/notice", NULL, $full), "url_wxapp" => "/pages/shop/notice/index/index" ), array( "name" => "消息通知", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/shop/notice/notification/notification" ),array( "name" => "购物车", "url" => mobileUrl("member/cart", NULL, $full), "url_wxapp" => "/pages/member/cart/index" ) ) ),
            array(
                "name" => "折扣宝",
                "list" => array(
		...
		if( $platform )
		{
			...
			{
				$allUrls[0]["list"][] = array( "name" => "卡路里商城", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/creditshop/index" );
			}
			...
			if( $platform != "wxapp_tabbar" && $platform != "" && cv("bargain") && p("bargain") ) 
			{
			...
			if( $platform != "wxapp_tabbar" && $platform != "" && cv("seckill") && p("seckill") ) 
			{
