...
$agentlevels=pdo_getall("ewei_shop_commission_level",array('uniacid'=>$_W['uniacid']));
if (p('offic')) {
...
if ($_W['ispost']) {
    ...
    $data['remote_dispatchtype'] = intval($_GPC['remote_dispatchtype']);
    ...
    $data['remote_dispatchid'] = intval($_GPC['remote_dispatchid']);
    if ($data['total'] === -1) {
        $data['total'] = 0;
        $data['totalcnf'] = 2;
    }
